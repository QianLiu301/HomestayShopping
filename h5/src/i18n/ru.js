export default {
  ...
  payment: { title: 'Сканировать для оплаты', amountToPay: 'Сумма к оплате', scanTip: 'Отсканируйте QR-код выше с помощью телефона для оплаты', confirmPaid: 'Я оплатил', cancelOrder: 'Оплатить позже', qrNotSet: 'QR-код не настроен, свяжитесь с нами', paymentSubmitted: 'Подтверждение оплаты отправлено, ожидает проверки' },
