export default {
  ...
  orders: {
    ...
    costPricePlaceholder: 'Enter cost of this order for profit tracking',
    profit: 'Profit',
  ...
  guides: {
    ...
    images: 'Guide Images',
    coverLabel: 'Cover',
    dragToReorder: 'Drag images to reorder. First image is used as cover.',
    category: 'Category',
    ...
    mapNamePlaceholder: 'Chinese place name, e.g. 上海迪士尼度假区',
    mapNameEnPlaceholder: 'English place name (shown on non-Chinese pages)',
  ...
  guestReg: {
    ...
    dateStart: 'Start Date',
    dateEnd: 'End Date',
    filterDate: 'Filter by check-in date',
    today: "Today's Check-ins",
    exportBtn: 'Export Excel (Last Month)',
    exportDayBtn: 'Export Excel (Check-ins That Day)',
    exportTodayBtn: "Export Today's Check-ins",
    exportTomorrowBtn: "Export Tomorrow's Check-ins",
    name: 'Name',
    dob: 'Date of Birth',
    docType: 'Document Type',
    docPassport: 'Passport',
    docHkMo: 'HK/Macao Permit',
    docTaiwan: 'Taiwan Permit',
    docNo: 'Document No.',
    groupedView: 'By Booking',
    allView: 'All Records',
    roomNote: 'Room Note',
    roomNotePrompt: 'Enter room name/note (applies to all guests in this group)',
    roomNotePlaceholder: 'e.g. Building 3, Room 502',
    noNote: 'No note',
    noteSaved: 'Room note saved',
    guests: 'Guests',
    groupStatus: 'Progress',
    markGroupDeclared: 'Mark Group Declared',
    markGroupPending: 'Mark Group Pending',
    mergeBtn: 'Merge Into One Group',
    mergeConfirm: 'Merge the selected {count} records into one group?',
    mergeSuccess: 'Merged successfully',
    selectAtLeastTwo: 'Please select at least two records',
    ...
    markGroupCancelled: 'Cancel Group',
    groupCancelConfirm: 'Mark the whole group as cancelled? (Use when the booking is cancelled / guests did not stay. Records are kept and can be restored.)',
